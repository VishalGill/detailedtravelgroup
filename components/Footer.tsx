    ...
    <footer className="bg-neutral-900 text-white">
      <div className="max-w-[1400px] mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-neutral-400 mb-6">
              Your premier luxury travel concierge, delivering exceptional experiences and personalized service around the world.
            </p>
          ...
          {/* Company */}
          <div>
            <h4 className="text-lg font-playfair font-bold mb-4">Company</h4>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/about"
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-playfair font-bold mb-4">Contact</h4>
            <ul className="space-y-3">
        ...
        <div className="border-t border-neutral-800 mt-12 pt-8 text-center text-neutral-400">
          <p>
            &copy; {currentYear} Detailed Travel Group. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
